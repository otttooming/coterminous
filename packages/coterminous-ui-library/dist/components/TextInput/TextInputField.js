...
class TextInputFieldBase extends React.Component {
  ...
  render() {
    const _a = this.props,
      { name, tagName } = _a,
      rest = __rest(_a, ['name', 'tagName']);
    switch (tagName) {
      case TextInput_1.TagName.Input:
        return React.createElement(
          TextInput_1.TextInput.Input,
          Object.assign({}, rest),
        );
      case TextInput_1.TagName.TextArea:
        return React.createElement(
          TextInput_1.TextInput.TextArea,
          Object.assign({}, rest),
        );
      default:
        return null;
...
exports.TextInputField = {
  Input: props =>
    React.createElement(
      TextInputFieldWithFormConsumer,
      Object.assign({}, props, { tagName: TextInput_1.TagName.Input }),
    ),
  TextArea: props =>
    React.createElement(
      TextInputFieldWithFormConsumer,
      Object.assign({}, props, { tagName: TextInput_1.TagName.TextArea }),
    ),
};
